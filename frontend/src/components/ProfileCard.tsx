    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="max-w-4xl mx-auto px-8 py-8 space-y-6">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 border-dashed opacity-60">
          ...
          <p className="text-gray-500 text-sm">Coming soon — your saved gems will appear here.</p>
        </div>

        {/* Placeholder: Activity */}
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 border-dashed opacity-60">
          <h2 className="text-lg font-semibold mb-2">Activity</h2>
          <p className="text-gray-500 text-sm">Coming soon — your recent activity will appear here.</p>
        </div>

        {/* Placeholder: Settings */}
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 border-dashed opacity-60">
          <h2 className="text-lg font-semibold mb-2">Settings</h2>
          <p className="text-gray-500 text-sm">Coming soon — account settings will appear here.</p>
        </div>
